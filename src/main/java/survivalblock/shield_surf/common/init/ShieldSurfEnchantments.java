...
public class ShieldSurfEnchantments {
    ...
    public static final Enchantment EXPULSION = new ShieldSurfingEnchantment(1, 6, Enchantment.Rarity.UNCOMMON, EnchantmentTarget.FISHING_ROD, EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND);
