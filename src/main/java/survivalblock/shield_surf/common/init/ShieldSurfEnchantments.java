...
public class ShieldSurfEnchantments {
    ...
    public static final Enchantment RAPID = new ShieldSurfingEnchantment(Enchantment.Rarity.RARE, EnchantmentTarget.FISHING_ROD, EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND);
    public static final Enchantment EXPULSION = new ShieldSurfingEnchantment(1, 6, Enchantment.Rarity.RARE, EnchantmentTarget.FISHING_ROD, EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND);
